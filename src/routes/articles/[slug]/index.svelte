...
<script lang="ts">
  ...
  import Comments from '/src/components/article/comments/Comments.svelte';
  import { commentsOpen } from '../../../stores/comments';
  import SocialButton from '/src/components/article/_SocialButton.svelte';
        ...
        <SocialButton
          on:click={() =>
            share(
              ...
              article.name,
              article.description,
              `https://thepaladin.news/articles/${article.slug}`
            )}>
