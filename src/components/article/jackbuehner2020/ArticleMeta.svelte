  ...
  {#if articleName && articleDescription && articleLocation}
    <div class={'social-buttons'}>
      <SocialButton
        ...
        on:click={() => {
          if (articleName && articleDescription && articleLocation) {
            share('facebook', articleName, articleDescription, articleLocation);
          }
        }}
      >
      ...
      <SocialButton
        ...
        on:click={() => {
          if (articleName && articleDescription && articleLocation) {
            share('twitter', articleName, articleDescription, articleLocation);
          }
        }}
      >
      ...
      <SocialButton
        ...
        on:click={() => {
          if (articleName && articleDescription && articleLocation) {
            share('email', articleName, articleDescription, articleLocation);
          }
        }}
      >
        <svg viewBox="0 0 24 24"
      ...
      <SocialButton
        ...
        on:click={() => {
          if (articleName && articleDescription && articleLocation) {
            share('linkedin', articleName, articleDescription, articleLocation);
          }
        }}
      >
        <svg viewBox="0 0 24 24"
