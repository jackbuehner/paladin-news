<script lang="ts">
  ...
  const buttonStyle = `
    ...
    --button-light-bg-hover: rgba(var(--primary-lighter), 0.12);
    --button-light-bg-active: rgba(var(--primary-lighter), 0.20);
...
<div>
  ...
  <Button
    ...
    on:click={() => {
      ...
      location.replace('https://www.google.com/search?q=weather.com');
    }}
  >
    <span>
      <svg viewBox="0 0 24 24">
